...
public class ProductController {
    ...
    private String  shoMasg() {
        ...
        // KỸ THUUTAAJ CHUYỂN DATA TỪ MODEL KIA SANG MODEL NÀY Ở CÂU LÊNNHJ REDIREECT VÌ REDIRECT LÀ GỌI URL MƯỚI MÀ URL MƯỚI LÀ NÓ CÓ THÙNG MỚI
        // MODEL ở ddaay ngoiaf data chính chủ hàm này còn nhận thêm từ bên post gửi sang
        return "results";
