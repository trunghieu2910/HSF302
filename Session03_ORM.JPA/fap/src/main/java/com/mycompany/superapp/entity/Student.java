...
public class Student {
    @Id
    @Column(name = "Id")// camelcase thì phải khai báo tên cột trong db, nếu không thì lấy tên biến làm tên cột
    // id tự nhập (id tự tang tính sau )
    private String id; //camelcase


    @Column(name = "Name" , nullable  =  false , length = 50) // không được null )
    @Nationalized // để lưu unicode ( tiếng việt có dấu ) , nếu không có thì lưu bình thường ( tiếng anh )
    private String name;
